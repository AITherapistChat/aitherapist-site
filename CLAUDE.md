...
**6. E-E-A-T** (для психологии критично): блок `.eeat` в конце — «Материал подготовлен командой AI Therapist… основан на КПТ/ACT/Mindfulness» + ссылка на авторитетный источник (ВОЗ: `https://www.who.int/news-room/fact-sheets/detail/anxiety-disorders`, `rel="noopener nofollow"`) + дисклеймер «не заменяет врача».
...
- добавить карточку в `blog/index.html` (хаб) и в секцию «Статьи» на `index.html` (главная);
